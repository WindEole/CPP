...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (amount < (unsigned int)ClapTrap::getHitPoints())
	{
		...
		std::cout << "ClapTrap " << ClapTrap::getName() << " receives " << amount << " damage ! ";
		std::cout << "He has " << ClapTrap::getHitPoints() << " Hit Points left." << std::endl;
	}
	else
	{
		this->_HitPoints = 0;
		std::cout << "ClapTrap " << ClapTrap::getName() << " receives " << amount;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		std::cout << "ClapTrap " << ClapTrap::getName() << " doesn't need to be repaired. Don't waste your Energy Points ! EP = " << this->_EnergyPoints << std::endl;
		return ;
	}
	this->_HitPoints += amount;
	if (this->_HitPoints >= this->_initialHP)
	{
		...
		std::cout << "ClapTrap " << ClapTrap::getName() << " is totally repaired ! He has " << this->_HitPoints << " Hit Points now. EP = " << this->_EnergyPoints << std::endl;		
	}
	else
	{
		std::cout << "ClapTrap " << ClapTrap::getName() << " has recovered " << amount << " Hit Points !";
		std::cout << " He has " << ClapTrap::getHitPoints() << " Hit Points now. EP = " << this->_EnergyPoints << std::endl;			
	}
}
...
bool	ClapTrap::check(void) const
{
	...
	{
		std::cout << "ClapTrap " << ClapTrap::getName() << " is dead..." << std::endl;
		return (false);
	}
	if (this->_EnergyPoints <= 0)
	{
		std::cout << "ClapTrap " << ClapTrap::getName() << " has no energy left, he can just hope for a swift death..." << std::endl;
		return (false);
	}
	return (true);
}
